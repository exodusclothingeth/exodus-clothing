// EXODUS CLOTHING - Complete Backend with Email
                ...
                await transporter.sendMail({
                    ...
                    html: `
                        <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 20px;">
                            ...
                            <p>We will contact you within 24 hours for delivery.</p>
                            <p>Questions? Call: ${YOUR_PHONE}</p>
                        </div>
                    `
                });
            ...
            try {
                await transporter.sendMail({
                    ...
                    html: `
                        ...
                        <p><strong>Total:</strong> ${total} ETB</p>
                        <h3>Items:</h3>
                        ${items.map(i => `<p>${i.name} (${i.size}) x${i.quantity} = ${i.price * i.quantity} ETB</p>`).join('')}
                    `
                });
...
║                                                              ║
║     Add EMAIL_PASS to environment variables to enable emails ║
╚═══════════════════════════════════════════════════════════════╝
    `);
});
